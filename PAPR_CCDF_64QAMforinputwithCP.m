...
cumulative = [] ; samplemax = max(PAPRo) ; numofsamples = 10000 ; samplemin = 0 ;
...
plot(paprvector,log10(cumulative),'c') ;
hold on ;
alphaA = 9 ;
